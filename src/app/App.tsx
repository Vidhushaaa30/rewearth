...
import { ChatPage } from "@/app/pages/ChatPage";   // ✅ NEW
        ...
        <main className="ml-64 flex-1 p-8">
          <div className="mx-auto max-w-7xl">
            <Routes>
              ...
              <Route path="/green-alternatives" element={<GreenAlternativesPage />} />
              <Route path="/exchange-fest" element={<ExchangeFestPage />} />
